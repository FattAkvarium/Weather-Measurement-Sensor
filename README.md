...
## Запуск
 ...
 2. Запустить [*скрипт БД*](https://github.com/FattAkvarium/Weather-Measurement-Sensor/blob/master/src/main/resources/database.properties.orig) для создания таблиц Sensor и Measurement
